 ...
 *
 * Date: Mon Aug 20 02:18:17 2012 +0200
 *
 */
...
function hpadding(element) {
	return (parseFloat($(element).css( 'paddingLeft')) || 0) +
	       (parseFloat($(element).css( 'paddingRight')) || 0);
}


function hmargins(element) {
	return (parseFloat($(element).css( 'marginLeft')) || 0) +
	       (parseFloat($(element).css( 'marginRight')) || 0);
}


function hborders(element) {
	alert((parseFloat($(element).css( 'borderLeftWidth')) || 0) +
	       (parseFloat($(element).css( 'borderRightWidth')) || 0))
	return (parseFloat($(element).css( 'borderLeftWidth')) || 0) +
	       (parseFloat($(element).css( 'borderRightWidth')) || 0);
}
...
function vpadding(element) {
	return (parseFloat($(element).css( 'paddingTop')) || 0) +
	       (parseFloat($(element).css( 'paddingBottom')) || 0);
}


function vmargins(element) {
	return (parseFloat($(element).css( 'marginTop')) || 0) +
	       (parseFloat($(element).css( 'marginBottom')) || 0);
}


function vborders(element) {
	return (parseFloat($(element).css( 'borderTopWidth')) || 0) +
	       (parseFloat($(element).css( 'borderBottomWidth')) || 0);
}
